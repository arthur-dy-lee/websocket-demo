 ...
 */
public class CoinPriceMain {

    private static final AtomicInteger count = new AtomicInteger(0);

    public static void main(String[] args) {
        URI uri = URI.create("wss://stream.bybit.com/spot/quote/ws/v2");  //注意协议号为ws
...
//        client.addHeader("token", "token-123456");              //这里为header添加了token，实现简单的校验
    ...
    static class MyTimerTask extends TimerTask {
        ...
        @Override
        public void run() {
            client.send("{\"symbol\":\"BTCUSDT\",\"topic\":\"trade\",\"event\":\"sub\",\"params\":{\"binary\":false}}");
        }
    }
}
